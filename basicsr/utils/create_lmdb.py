...
def create_lmdb_for_SHG():
    folder_path1 = './datasets/STACK_CHANNELS/train/input_crops'
    lmdb_path = './datasets/STACK_CHANNELS/train/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path1, 'PNG')
    print('img_path_list = ', img_path_list)
    print("Keys = ", keys)
    make_lmdb_from_imgs(folder_path1, lmdb_path, img_path_list, keys)

    folder_path2 = './datasets/STACK_CHANNELS/train/gt_crops'
    lmdb_path = './datasets/STACK_CHANNELS/train/gt_crops.lmdb'

    img_path_list2, keys = prepare_keys(folder_path2, 'PNG')
    make_lmdb_from_imgs(folder_path2, lmdb_path, img_path_list, keys)
